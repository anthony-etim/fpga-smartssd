...
if __name__ == "__main__":
    ...
    plot_path     = '/home/ubuntu/vitis_accel_examples/rtl_kernels/rtl_ro1/experiments/plots/covert_channel_two_users/'
    data_path_list = []
    ro_counts = []
    ...
    plt.savefig(plot_path + "ro_counts_covert_threshold_histogram_vmacell.png")
    plt.clf()