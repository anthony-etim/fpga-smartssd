...
if __name__ == "__main__":
    ...
    original_bits = []
    predicted_bits = []
    ssd_0_threshold = 66 ## baseline temperature for experiment 

    data_path_pwd = '/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_heater_cloudfpga/experiments/heater_logs/covert_channel_fpga_ssd_single/covert_channel_fpga_ssd_0/'
    plot_path = '/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_heater_cloudfpga/experiments/plots/heater/'
    bit_path = '/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_heater_cloudfpga/experiments/heater_logs/covert_channel_fpga_ssd_single/covert_channel_fpga_ssd_0_32_bit.log'
    data_path_list = []
