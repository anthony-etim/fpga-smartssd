...
if __name__ == "__main__":
    ...
    plot_path     = '/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_ro1_cloudfpga/experiments/ro_counts_logs/covert_channel_ssd_fpga_single/'
    data_path_list = []
    ro_counts = []
    ...
    # data_path_list= data_path_list[0:2]
    ...
    # ro_counts_tmp = [x[0:1200] for x in ro_counts_tmp]
    # print((ro_counts_tmp[0]))
    # ro_counts_tmp_run_1 = ro_counts_tmp[0:2]
    ...
    # for i in range(len(ro_counts_tmp_run_1)):
    ...
    plt.savefig(plot_path + "ro_counts_covert_channel_histogram_ssd_fpga.pdf")
    plt.clf()