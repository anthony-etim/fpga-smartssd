...
*/
    ...
    */
    ...
    // std::string data_path = "/home/ubuntu/vitis_accel_examples/rtl_kernels/rtl_ro1/experiments/data/"; // path on VMAccel
    // std::string data_path = "/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_ro1/experiments/data/"; // cloudfpga server path
    std::string data_path = "/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_ro1_cloudfpga/experiments/ro_counts_logs/covert_channel_ssd_fpga_single/covert_channel_ssd_fpga_0/"; // cloudfpga server path

    // std::string date_time = date::format("%F %T %Z", date::make_zoned(date::current_zone(),std::chrono::system_clock::now()));
