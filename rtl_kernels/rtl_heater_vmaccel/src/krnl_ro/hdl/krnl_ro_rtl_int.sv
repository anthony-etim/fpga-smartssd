...
// of this module is to multiply two 32-bit values and produce a result.  The values
...
module krnl_ro_rtl_int #( 
  ...
  parameter integer  MAX_RO_HEATERS = 5
)
(
  // System signals
  input  wire  ap_clk,
...
///////////////////////////////////////////////////////////////////////////////
localparam integer LP_NUM_READ_CHANNELS  = 3;
...
logic [31:0] ro_heater_on_num = 32'd5;
