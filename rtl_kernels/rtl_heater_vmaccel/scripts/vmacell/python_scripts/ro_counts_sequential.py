...
if __name__ == "__main__":
    data_path_pwd = '/home/ubuntu/vitis_accel_examples/rtl_kernels/rtl_ro1/experiments/data_sequential_final_correct/'
    ...
    plt.xlim(-2,601)
    plt.grid()
    plt.savefig(plot_path + "ro_counts_sequential_vmaccel_final_sequential.pdf")
    plt.clf()
