...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set Memory_configuration [ipgui::add_page $IPINST -name "Memory configuration"]
  set C_MEM_SIZE [ipgui::add_param $IPINST -name "C_MEM_SIZE" -parent ${Memory_configuration}]
  set_property tooltip {Memory Size in Bytes} ${C_MEM_SIZE}
