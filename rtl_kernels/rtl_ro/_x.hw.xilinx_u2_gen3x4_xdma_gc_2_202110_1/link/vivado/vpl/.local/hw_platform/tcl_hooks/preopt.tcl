...
add_cells_to_pblock [get_pblocks pblock_dynamic_region] [get_cells level0_i/ulp]
...
set_param hd.enableVerticalExpansion  1
...
create_waiver -id HDPR-108 -type DRC -user “user_name” -desc {Downgrading false flag DRC}
