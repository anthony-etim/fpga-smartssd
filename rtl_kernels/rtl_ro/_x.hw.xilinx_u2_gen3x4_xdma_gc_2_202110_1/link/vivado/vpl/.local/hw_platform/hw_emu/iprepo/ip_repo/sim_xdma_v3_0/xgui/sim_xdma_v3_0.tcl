...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set SIM_XDMA_configuration [ipgui::add_page $IPINST -name "SIM XDMA configuration"]
  set C_STM_ITF_ENABLE [ipgui::add_param $IPINST -name "C_STM_ITF_ENABLE" -parent ${SIM_XDMA_configuration}]
  set_property tooltip {Streaming interface to connect to STM model} ${C_STM_ITF_ENABLE}
  set C_M_AXIMM_AUX_ENABLE [ipgui::add_param $IPINST -name "C_M_AXIMM_AUX_ENABLE" -parent ${SIM_XDMA_configuration}]
