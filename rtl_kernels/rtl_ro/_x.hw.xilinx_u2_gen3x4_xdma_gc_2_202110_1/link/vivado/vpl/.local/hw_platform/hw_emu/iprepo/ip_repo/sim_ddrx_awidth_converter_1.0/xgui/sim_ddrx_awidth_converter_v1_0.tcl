...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_MASTER_ID" -parent ${Page_0}

}

proc update_PARAM_VALUE.C_MASTER_ID { PARAM_VALUE.C_MASTER_ID } {
	# Procedure called to update C_MASTER_ID when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_MASTER_ID { PARAM_VALUE.C_MASTER_ID } {
	# Procedure called to validate C_MASTER_ID
	return true
}
...
proc update_MODELPARAM_VALUE.C_MASTER_ID { MODELPARAM_VALUE.C_MASTER_ID PARAM_VALUE.C_MASTER_ID } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_MASTER_ID}] ${MODELPARAM_VALUE.C_MASTER_ID}
}
