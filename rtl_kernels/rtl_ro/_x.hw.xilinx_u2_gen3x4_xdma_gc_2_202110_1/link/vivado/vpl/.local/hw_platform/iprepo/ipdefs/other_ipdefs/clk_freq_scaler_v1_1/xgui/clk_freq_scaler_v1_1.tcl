...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set Page_0 [ipgui::add_page $IPINST -name "Page 0" -display_name {clock frequency scaler Config}]
  set_property tooltip {NM Counter config} ${Page_0}
  ...
  ipgui::add_param $IPINST -name "C_NUM_PATTERN_REG" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_PATTERN_REG_WIDTH" -parent ${Page_0}
}
...
proc update_PARAM_VALUE.C_NUM_PATTERN_REG { PARAM_VALUE.C_NUM_PATTERN_REG } {
	# Procedure called to update C_S_AXI_LITE_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_PATTERN_REG_WIDTH { PARAM_VALUE.C_PATTERN_REG_WIDTH } {
	# Procedure called to validate C_S_AXI_LITE_ADDR_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_NUM_PATTERN_REG { MODELPARAM_VALUE.C_NUM_PATTERN_REG PARAM_VALUE.C_NUM_PATTERN_REG } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_NUM_PATTERN_REG}] ${MODELPARAM_VALUE.C_NUM_PATTERN_REG}
}

proc update_MODELPARAM_VALUE.C_PATTERN_REG_WIDTH { MODELPARAM_VALUE.C_PATTERN_REG_WIDTH PARAM_VALUE.C_PATTERN_REG_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_PATTERN_REG_WIDTH}] ${MODELPARAM_VALUE.C_PATTERN_REG_WIDTH}
}
