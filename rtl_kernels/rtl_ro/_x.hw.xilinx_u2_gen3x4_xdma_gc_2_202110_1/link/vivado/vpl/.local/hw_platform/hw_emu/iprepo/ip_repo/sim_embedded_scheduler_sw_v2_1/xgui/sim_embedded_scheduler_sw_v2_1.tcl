...
proc update_PARAM_VALUE.SCHEDULER_LIB_PATH { PARAM_VALUE.SCHEDULER_LIB_PATH } {
	# Procedure called to update SCHEDULER_LIB_PATH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SCHEDULER_LIB_PATH { PARAM_VALUE.SCHEDULER_LIB_PATH } {
	# Procedure called to validate SCHEDULER_LIB_PATHUM
	return true
}
...
proc update_MODELPARAM_VALUE.SCHEDULER_LIB_PATH { MODELPARAM_VALUE.SCHEDULER_LIB_PATH PARAM_VALUE.SCHEDULER_LIB_PATH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SCHEDULER_LIB_PATH}] ${MODELPARAM_VALUE.SCHEDULER_LIB_PATH}
}
