...
source [file join [file dirname [file dirname [info script]]] gui/sim_aximm_perf_gui.gtcl]
...
proc init_gui { IPINST } {
  ...
  set EN_AXI_LITE [ipgui::add_param $IPINST -name "EN_AXI_LITE" -parent ${Page_0} -widget checkBox]
  set_property tooltip {Enable AxiLite Interface} ${EN_AXI_LITE}
  #Adding Group
  set AXI_Properties [ipgui::add_group $IPINST -name "AXI Properties" -parent ${Page_0}]
  ipgui::add_param $IPINST -name "ID_WIDTH" -parent ${AXI_Properties}
  ipgui::add_param $IPINST -name "ADDR_WIDTH" -parent ${AXI_Properties}
  ipgui::add_param $IPINST -name "DATA_WIDTH" -parent ${AXI_Properties}
  #Adding Group
  ...
  ipgui::add_param $IPINST -name "MONITOR_ID" -parent ${Trace}
