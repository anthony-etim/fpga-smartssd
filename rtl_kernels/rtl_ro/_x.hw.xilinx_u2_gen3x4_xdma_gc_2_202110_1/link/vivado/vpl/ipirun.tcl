...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_RTLKernel_krnl_ro_rtl_int_1_0"]
set install_ip_cache "/tools/Xilinx/Vitis/2021.1/data/cache/xilinx"
...
lappend bus_sp_tags C0_DDR4_ADDRESS_BLOCK bank0
lappend bus_sp_indeces C0_DDR4_ADDRESS_BLOCK 0
lappend bus_slrs C0_DDR4_ADDRESS_BLOCK SLR0
lappend bus_sp_tags Mem0 plram
lappend bus_sp_indeces Mem0 0
lappend bus_slrs Mem0 SLR0

set hw_platform_info [dict create \
  hw_platform_dir              ".local/hw_platform" \
  hw_platform_file             "/opt/xilinx/platforms/xilinx_u2_gen3x4_xdma_gc_2_202110_1/hw/hw.xsa" \
  hw_platform_part             "xcku15p-ffva1156-2LV-e" \
  hw_platform_vbnv             "xilinx:u2:gen3x4_xdma_gc_2:202110.1" \
  ...
  hw_platform_dr_bd            ".local/hw_platform/bd/202110_1_dev.srcs/sources_1/bd/ulp/ulp.bd" \
  ...
  emu_user_ip_repo             "" \
  emu_src_dir                  "" \
  emu_pfm_metadata_version     "2021.1" \
  contains_emu_dir              false \
  hw_platform_board_repo       ".local/hw_platform/board" \
  hw_platform_bconn_locked      {} \
  hw_platform_bconn_unlocked    {} \
  hw_platform_board_part       "xilinx.com:u2:part0:1.0" \
  link_output_format           "bitstream" \
  xpfm_file                    "/opt/xilinx/platforms/xilinx_u2_gen3x4_xdma_gc_2_202110_1/xilinx_u2_gen3x4_xdma_gc_2_202110_1.xpfm" \
...
# kernel clock 'PL 1' (1)
set dict_blp_s_aclk_kernel2_ref_clk_00 [dict create \
  is_user_set false \
  instance _bd_top \
  port blp_s_aclk_kernel2_ref_clk_00 \
  clk_id 1 \
  freq 500.000000 \
];
# kernel clock 'PL 0' (0)
set dict_blp_s_aclk_kernel_ref_clk_00 [dict create \
  is_user_set false \
  instance _bd_top \
  port blp_s_aclk_kernel_ref_clk_00 \
  clk_id 0 \
  freq 300.000000 \
];

set kernel_clock_freqs [dict create \
  blp_s_aclk_kernel2_ref_clk_00 $dict_blp_s_aclk_kernel2_ref_clk_00 \
  blp_s_aclk_kernel_ref_clk_00 $dict_blp_s_aclk_kernel_ref_clk_00 \
];
