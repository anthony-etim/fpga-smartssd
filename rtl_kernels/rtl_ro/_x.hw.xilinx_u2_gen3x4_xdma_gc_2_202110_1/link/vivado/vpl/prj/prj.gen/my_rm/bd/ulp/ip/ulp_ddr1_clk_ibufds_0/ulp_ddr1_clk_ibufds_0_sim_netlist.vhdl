...
-- Date        : Fri Dec 31 12:04:40 2021
-- Host        : caslab-cloudfpga running 64-bit Ubuntu 18.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top ulp_ddr1_clk_ibufds_0 -prefix
--               ulp_ddr1_clk_ibufds_0_ ulp_ddr1_clk_ibufds_0_sim_netlist.vhdl
...
entity ulp_ddr1_clk_ibufds_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of ulp_ddr1_clk_ibufds_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of ulp_ddr1_clk_ibufds_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of ulp_ddr1_clk_ibufds_0_util_ds_buf : entity is "IBUFDS";
  attribute C_MODE : string;
  attribute C_MODE of ulp_ddr1_clk_ibufds_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of ulp_ddr1_clk_ibufds_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of ulp_ddr1_clk_ibufds_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of ulp_ddr1_clk_ibufds_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of ulp_ddr1_clk_ibufds_0_util_ds_buf : entity is 1;
end ulp_ddr1_clk_ibufds_0_util_ds_buf;

architecture STRUCTURE of ulp_ddr1_clk_ibufds_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ulp_ddr1_clk_ibufds_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of ulp_ddr1_clk_ibufds_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ulp_ddr1_clk_ibufds_0 : entity is "ulp_ddr1_clk_ibufds_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of ulp_ddr1_clk_ibufds_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of ulp_ddr1_clk_ibufds_0 : entity is "util_ds_buf,Vivado 2021.1";
end ulp_ddr1_clk_ibufds_0;

architecture STRUCTURE of ulp_ddr1_clk_ibufds_0 is
...
begin
U0: entity work.ulp_ddr1_clk_ibufds_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
