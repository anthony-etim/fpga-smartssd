...
if __name__ == "__main__":
    ...
    bit_path      = '/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_heater_vmaccel/experiments/heater_logs/covert_channel_ssd_heater_ssd_sensor/covert_channel_ssd_heater_ssd_sensor_32_bit_6000.log'
    data_path_list = []
    ro_counts = []
    original_bits_str = []
    original_bits = []
