...
if __name__ == "__main__":
    ...
    data_path_pwd = '/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_ro1_vmaccel/experiments/data_smart_ssd_1_ssd_heater_ssd_sensor_6000/'
    plot_path     = '/home/aee38/Documents/vitis_accel_examples/rtl_kernels/rtl_ro1_vmaccel/experiments/plots/covert_channel_ssd_heater_ssd_sensor/'
    data_path_list = []
    ro_counts = []
    ...
    for i in range(len(ro_counts_tmp)):
        ...
        fig_ro_1 = plt.hist(ro_counts_tmp[i], bins='auto', alpha=0.8)
    ...
    plt.savefig(plot_path + "ro_counts_covert_channel_histogram_ssd_heater_ssd_sensor_6000_new.pdf")
    plt.clf()