...
do
    ...
    do
        bit=$(($RANDOM%2))
        # saving bit
        echo "x is  ${x}" >> "/home/ubuntu/vitis_accel_examples/rtl_kernels/rtl_ro1/scripts/vmacell/bash_scripts/logs_covert/bit.log"
        echo "y is  ${y}" >> "/home/ubuntu/vitis_accel_examples/rtl_kernels/rtl_ro1/scripts/vmacell/bash_scripts/logs_covert/bit.log"
        echo "bit is ${bit}" >> "/home/ubuntu/vitis_accel_examples/rtl_kernels/rtl_ro1/scripts/vmacell/bash_scripts/logs_covert/bit.log"
        echo "" >> "/home/ubuntu/vitis_accel_examples/rtl_kernels/rtl_ro1/scripts/vmacell/bash_scripts/logs_covert/bit.log"
